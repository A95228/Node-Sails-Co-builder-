...
module.exports = {
   ...
   *                                                                         *
   **************************************************************************/
  // NOTE custom method for connecting redis server single time
  getRedisClient () {
    return sails.config.custom.redisConnectionObject
  },
  datastores: {
    /***************************************************************************
     *                                                                          *
    ...
    default: {
      ...
      url:
        'postgresql://stageadmin:ychpg4pqnp4nrdbu@cobuilder-stage.chctmqdczyyo.eu-west-1.rds.amazonaws.com:5432/db_thecobuilders'
      //'postgresql://thecobuilders:P1OCjsP874IqN5d4xz@104.219.248.148:5432/db_thecobuilders'
      //--------------------------------------------------------------------------
  ...
  security: {
    ...
    cors: {
      ...
      // allowOrigins: '*',
      allowOrigins: [
        'http://104.219.248.148:8081',
        'http://104.219.248.148:8082',
        'http://104.219.248.148:1337',
        'https://stage.thecobuilders.com',
        'https://adminstage.thecobuilders.com',
      ],
      allowRequestHeaders: [
        'content-type, Authorization, Access-Control-Allow-Origin'
      ],
      allowResponseHeaders: ['content-type, Access-Control-Allow-Origin']
  ...
  sockets: {
    ...
    pingInterval: 10000,//10sec set default ping pong request time
    pingTimeout: 60000,
    afterDisconnect: function (session, socket, cb) {
      console.log(`------------------ REDIS Disconnected ------------------`)
    },
    onRedisDisconnect: function () {
      console.log(`------------------ onRedisDisconnect ------------------`)
    },
    onRedisReconnect: function () {
      console.log(`------------------ onRedisReconnect ------------------`)
    }
