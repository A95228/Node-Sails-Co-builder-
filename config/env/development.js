...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      url: 'postgresql://postgresql:12345@localhost:20172/postgresql'
      //--------------------------------------------------------------------------
  ...
  security: {
    ...
    cors: {
      ...
      allowOrigins: [
        ...
        'http://0.0.0.0:8080',
        'http://localhost:9527',
        // 'http://192.168.1.153:9527',
        // 'http://192.168.1.154:9527',
        'http://127.0.0.1:9527',
        'http://0.0.0.0:9527'
      ],
      allowRequestHeaders: [
  ...
  sockets: {
    ...
    //   console.log(`------------------ REDIS CONNECTED at ${this.url} @ ${new Date()}------------------`)
    // },
    // beforeConnect: function (handshake, proceed) {
    //   console.log('development.js Line(280)-----------------------------------------------------------------------')
    //   console.log(handshake)
    //   console.log('development.js Line(280)-----------------------------------------------------------------------')
    //   // console.log('development.js Line(282)')
    //   // console.log(handshake)
    //   handshake.on('packet', (data) => {
    //     console.log('development.js Line(282)')
